...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment", type=str, default="launch_attack")
    ...
    parser.add_argument("--src_dir", type=str, default="/data/datasets/round1-holdout-dataset/")
    parser.add_argument("--checkpoint_dir", type=str, default="/code/unv_pert_feat/round1_holdout")
