...
if __name__ == "__main__":
    # Initialize paths
    model_dir = "/data/ksikka/projects_2020/trojAI/round2-dataset-train"
    meta_data = pd.read_csv(
        "/data/ksikka/projects_2020/trojAI/round2-dataset-train/METADATA.csv"
    )
    feature_dir = "/data/ksikka/mount/rebel/ksikka/k8s/trinityTrojAI/users/ksikka/cvpr_exp/troj_round2/curve_features"
